...
<center>
![](data/img/figure3_gda_network.png){width=100%}
...
<center>
![](data/img/figure4_asthma_vdas.png){width=100%} 
</center>
...
```
<center>
![](data/img/figure5_variants_vdas.png){width=100%}</center>
...
datatable(dt, caption = "Table 1: Top 20 diseases associated to the list of variants" ,  rownames = FALSE, class = 'cell-border stripe', filter = 'top',
...
<center>
![](data/img/figure6_variants_vdas_asthma.png){width=100%}
</center>
...
<center>
![](data/img/figure7_variants_vdas_resp.png){width=100%}
...
<center>
![](data/img/figure8_variant_enrichment.png){width=70%}
</center>
...
top_nodes <- getTableColumns('node', network = gda_enrich_result$result$newNetworkProperties$SUID)
